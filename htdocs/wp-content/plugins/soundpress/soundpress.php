...
Plugin URI:  https://soundpressplugin.wordpress.com/
Description: SoundCloud plugin for WordPress
Version:     2.2.2
Author:      Emad Messiha
Author URI:  https://soundpressplugin.wordpress.com/
License:     GPL2
...
class wp_soundpress_plugin extends WP_Widget {
	...
	function form($instance) {	
        ...
        <input class="widefat" id="<?php echo $this->get_field_id('soundcloud_url'); ?>" name="<?php echo $this->get_field_name('soundcloud_url'); ?>" type="text" value="<?php echo $soundcloud_url; ?>" />
        </p>
...
// register widget
add_action('widgets_init', create_function('', 'return register_widget("wp_soundpress_plugin");'));
?>